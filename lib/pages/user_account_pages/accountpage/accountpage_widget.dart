  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final accountpageUsersRecord = accountpageUsersRecordList.isNotEmpty
            ? accountpageUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: const Text(
                                                                    'Change Password'),
                                                                content: const Text(
                                                                    'Are you sure to change your passworrd? A password reset link will send to your email.'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
